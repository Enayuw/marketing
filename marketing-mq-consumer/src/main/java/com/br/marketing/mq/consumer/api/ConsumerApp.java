...
public class ConsumerApp {
    ...
    public void consumerXieChengActivate(Channel channel, Message message) {
        log.warn("MARKETING_XIECHENG_COLLIDING_ACTIVATE_QUEUE：获取消息成功");
        XieChengActivateDTO xieChengActivateDTO = JSON.parseObject(new String(message.getBody(), StandardCharsets.UTF_8), new TypeReference<XieChengActivateDTO>() {
        }.getType());
