...
@RocketMQMessageListener(endpoints = "${rocketmq.consumer.endpoints:}",
        ...
        consumerGroup = MarketingTransferConstants.MARKETING_TRANSFER_RECEIVE_SMALL,
        tag = MarketingTransferConstants.TAG_MARKETING_TRANSFER_RECEIVE_SMALL,consumptionThreadCount = 20)
public class MarketingTransferReceiveSmallConsumer extends BaseMqMessageListener implements RocketMQListener {
