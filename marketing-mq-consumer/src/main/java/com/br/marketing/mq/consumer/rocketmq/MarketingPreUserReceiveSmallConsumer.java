...
@RocketMQMessageListener(endpoints = "${rocketmq.consumer.endpoints:}",
        ...
        tag = MarketingUploadConstants.TAG_MARKETING_PRE_USER_RECEIVE_SMALL,consumptionThreadCount = 20)
public class MarketingPreUserReceiveSmallConsumer extends BaseMqMessageListener implements RocketMQListener {
