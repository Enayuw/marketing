...
@RocketMQMessageListener(endpoints = "${rocketmq.consumer.endpoints:}",
        ...
        tag = MarketingUploadConstants.TAG_MARKETING_PRE_USER_RECEIVE,consumptionThreadCount = 20)
public class MarketingPreUserReceiveConsumer extends BaseMqMessageListener implements RocketMQListener {
