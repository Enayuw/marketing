...
@RocketMQMessageListener(endpoints = "${rocketmq.consumer.endpoints:}",
        ...
        consumerGroup = MQConstants.MARKETING_PREUSER_RECEIVE_EMERGENCY,
        tag = MQConstants.ROUTING_KEY_MARKETING_PREUSER_RECEIVE_EMERGENCY,consumptionThreadCount = 20)
public class MarketingPreUserReceiveEmergencyConsumer extends BaseMqMessageListener implements RocketMQListener {
