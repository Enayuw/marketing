...
public class MarketingPushDaasTransferConsumer extends BaseMqMessageListener implements RocketMQListener<MessageExt> {
    ...
    protected void handleMessage(MessageExt messageExt) {
        ...
        if(rocketMQSwitch.rocketLogSwitchFlag(MarketingOutsideInterfaceConstants.TAG_MARKETING_PUSH_DAAS_TRANSFER)){
            log.warn("MARKETING_PUSH_DASS_TRANSFER：storeTimestamp[{}]msgId[{}]brokerName[{}]topic[{}]tags[{}]获取消息成功:{}"
