...
@RocketMQMessageListener(endpoints = "${rocketmq.consumer.endpoints:}",
        ...
        tag = MarketingOutsideInterfaceConstants.TAG_MARKETING_PUSH_DAAS_SCORE,consumptionThreadCount = 20)
public class MarketingPushDaasScoreConsumer extends BaseMqMessageListener implements RocketMQListener {
