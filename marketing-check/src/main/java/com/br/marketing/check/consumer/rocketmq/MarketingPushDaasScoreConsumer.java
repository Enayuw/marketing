...
public class MarketingPushDaasScoreConsumer extends BaseMqMessageListener implements RocketMQListener<MessageExt> {
    ...
    protected void handleMessage(MessageExt messageExt) {
        ...
        if(rocketMQSwitch.rocketLogSwitchFlag(MarketingOutsideInterfaceConstants.TAG_MARKETING_PUSH_DAAS_SCORE)){
            log.warn("MARKETING_PUSH_DASS_SCORE：storeTimestamp[{}]msgId[{}]brokerName[{}]topic[{}]tags[{}]获取消息成功:{}"
