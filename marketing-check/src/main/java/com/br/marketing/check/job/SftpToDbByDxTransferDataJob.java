...
public class SftpToDbByDxTransferDataJob extends AbstractSimpleElasticJob {
    ...
    public void process(JobExecutionMultipleShardingContext jobExecutionMultipleShardingContext) {
        ...
        List<String> apiCodes = marketingCustomers.stream().filter(t->iCompatibleService.isAction(t.getExtendConfigInfo())).map(t -> t.getApiCode()).collect(Collectors.toList());
