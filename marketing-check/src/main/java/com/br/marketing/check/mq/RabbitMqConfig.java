...
public class RabbitMqConfig {
    ...
    @Bean
    public Binding bindingPushOutBoundQueue() {
        return BindingBuilder.bind(pushOutBoundQueue()).to(gateExchange()).with(MQConstants.ROUTING_KEY_MARKETING_PUSH_DATA_SCORE);
    }
