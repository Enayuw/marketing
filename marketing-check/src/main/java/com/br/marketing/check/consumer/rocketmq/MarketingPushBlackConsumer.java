...
@RocketMQMessageListener(endpoints = "${rocketmq.consumer.endpoints:}",
        ...
        consumerGroup = MQConstants.MARKETING_PUSH_BLACK,
        tag = MQConstants.ROUTING_KEY_MARKETING_PUSH_BLACK,consumptionThreadCount = 20)
public class MarketingPushBlackConsumer extends BaseMqMessageListener implements RocketMQListener {
    ...
    protected ConsumeResult handleMessage(MessageView messageView) throws Exception {
        ...
        log.warn("Marketing_Push_Black：获取消息成功:{}",o);
        consumerService.consumerRun(messageView, pushRuleService::consumerCommonBlack, o, null);
