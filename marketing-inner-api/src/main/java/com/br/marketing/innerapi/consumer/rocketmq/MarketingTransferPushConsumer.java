...
public class MarketingTransferPushConsumer extends BaseMqMessageListener implements RocketMQListener<MessageExt> {
    ...
    protected void handleMessage(MessageExt messageExt) {
        ...
        if(rocketMQSwitch.rocketLogSwitchFlag(MarketingOutsideInterfaceConstants.TAG_MARKETING_TRANSFER_PUSH_CUSTOMER)){
            log.warn("Marketing_Transfer_Push_Customer：storeTimestamp[{}]msgId[{}]brokerName[{}]topic[{}]tags[{}]获取消息成功:{}"
