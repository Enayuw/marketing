...
import com.br.marketing.file.utils.CheckDataUtil;
...
public class ValidatorSmallFileThread implements Callable<String> {
    ...
    public ValidatorSmallFileThread(FileContext context,Map<String,String> param,Writer errorfw,AtomicLong desTime,Integer checkOpen) {
        ...
        this.decodeClient= FileApplication.ac.getBean(DecodeGrpcClient.class);
        this.marketingUserMapper = FileApplication.ac.getBean(MarketingUserMapper.class);
        this.marketingDirtyUserMapper = FileApplication.ac.getBean(MarketingDirtyUserMapper.class);;
        this.batchNumber=context.getTask().getBatchNumber();
        this.redisChgService=FileApplication.ac.getBean(RedisChgService.class);
