...
@Component
@Slf4j
public class TcCpaSyncDataDownFileShardJob extends AbstractSimpleElasticJob {
    ...
    @Resource
    private TcCpaSyncDataDownFileService tcCpaSyncDataDownFileService;


    @Override
    public void process(JobExecutionMultipleShardingContext shardingContext) {
        try {
            tcCpaSyncDataDownFileService.process(marketingCommonConfig.getTcyrCpaApiCode());
        }catch (Exception e) {
