...
public class ResultUtil {
   ...
   // private  static String sep="\001";
    ...
    public static void generateFile(JSONObject resultJson, String strategyId, Writer fw,  String  sep ,
                                    String cusNum,String batchNumber,Map<String,String> proFieldMap,String apiCode) throws IOException {
        log.info("cus_num：{} 画像流水:{}",cusNum,resultJson);
         ...
         * 添加基本信息
         */
              sb.append(new SimpleDateFormat("yyyy-MM-dd").format(new Date())).append(sep)
        ...
        log.info("batch_number:{} products:{}",batchNumber,products);
        ProductResultUtil.dealProResult(hxJson,products,sb,proFieldMap,sep,apiCode);
