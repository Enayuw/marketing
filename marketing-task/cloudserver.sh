...
JAVA_CMD="$CLOUDSERVER_JAVA_CMD $JAVA_OPTIONS $PINPOINT_OPTIONS $RASP_OPTIONS -Dspeed.env=$SPEED_ENV -DjarPath=$SERVICE_HOME/lib/$APP_JAR_NAME --Dspring.profiles.active=$CONF_ENV  -jar $SERVICE_HOME/lib/$APP_JAR_NAME "
