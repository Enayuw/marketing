...
@Tag(name = "同程易融cpa代运营测试", description = "免客户端签；代签/验签使用 Speed tcyrRelayTestServerConfig（空则回退 tcyrServerConfig），经 ThreadLocal 与正式链路隔离")
...
public class TcCpaCustomizeWithoutSignController {
    ...
    private void signRequest(TcRequestDTO tcRequestDTO) {
