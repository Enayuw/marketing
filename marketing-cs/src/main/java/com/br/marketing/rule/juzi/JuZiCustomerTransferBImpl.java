 ...
 * @Date : Create in 2022/10/18 10:28
 */
@Service
public class JuZiCustomerTransferBImpl implements AssembleData<ConversionData> {
    ...
    public ConversionData assemble(Object transmitFact, ProcessHandlerContext context) {
        ...
        if(!StringUtils.isEmpty(transfer.getLentTime())){
    ...
    public boolean isNeedAssemble(Object transmitFact, ProcessHandlerContext context) {
         ...
         */
        return "0".equals(transfer.getUnlentAmount());
    }

    @Override
    public String label() {
        return "JuZi_TransferData_B_CustomerTransfer";
    }
