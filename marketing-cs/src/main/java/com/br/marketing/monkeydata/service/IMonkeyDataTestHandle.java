...
public abstract class IMonkeyDataTestHandle<I, O, R extends InputDataCondition> {

    Logger log = LoggerFactory.getLogger(IMonkeyDataTestHandle.class);
