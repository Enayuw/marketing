...
public class IOUtil {
    ...
    /**
     * 从输入流中读取数据并转换为字符串，使用平台默认字符集，读完后关闭输出流
     *
     * @param in
     * @return
     * @throws IOException
    ...
    /**
     * 从输入流中读取数据，按行转换为字符串集合，使用平台默认字符集，读完后关闭输出流
     *
     * @param in
     * @return
     * @throws IOException
    ...
    public static void writeLines(List<String> lines, String lineSeparator, OutputStream out, String charset)
            throws IOException {
        if (lines == null || lines.isEmpty() || out == null) {
            return;
        }
     ...
     * @throws IOException
     */
    public static void writeStr(String str, OutputStream out) throws IOException {
        writeStr(str, out, null);
    }
     ...
     * @throws IOException
     */
    public static void writeStr(String str, OutputStream out, String charset) throws IOException {
        writeLines(Arrays.asList(str), null, out, charset);
    }
