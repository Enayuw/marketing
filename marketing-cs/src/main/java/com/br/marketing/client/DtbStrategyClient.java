...
public class DtbStrategyClient {
     ...
     *         "createUser":"李博文测试",
     *         "dataProdList":"{"dataProdList":[{"code":"KeyAttribution","version":"V1.0"},
     *         {"code":"SpecialList_c","version":"V1.0"}
     *         ,{"code":"TotalLoan","version":"V1.0"},{"code":"Stability_c","version":"V2.0"},
     *         {"code":"Consumption_c","version":"V2.0"}
     *         ,{"code":"ApplyLoanStr","version":"V2.0"},{"code":"InfoRelation","version":"V2.0"},
     *         {"code":"ApplyLoan_d","version":"V2.0"}
     *         ,{"code":"ApplyLoanInterval","version":"V1.0"},{"code":"ApplyLoanMon","version":"V2.0"},
     *         {"code":"Media_c","version":"V2.0"}]}",
     *         "datastrCode":"DTB0000013",
     *         "datastrDesc":"但是",
     *         "datastrName":"测试",
     *         "id":626,
    ...
    public String getStrategyList(String sessionId) {
        ...
        log.info("开始调用数据策略配置服务--sessionId:{}",sessionId);
        String result = loadBalanced.getForObject("http://strategycenter-service/dataStrategy" +
    ...
    public String getAllStrategy(String sessionId){
        ...
        Map<String, Object> urlVariables = new HashMap<>();
        urlVariables.put("sessionId",sessionId);
        String forObject = loadBalanced.getForObject("http://strategycenter-service/strategy/getAllLoanStrategys" +
