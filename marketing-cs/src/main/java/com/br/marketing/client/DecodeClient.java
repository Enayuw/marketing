...
public class DecodeClient {
    ...
    public   String query(String param,String type,String alogrithm,String swiftNumber){
     ...
     * @return
     */
    public   String decode(String type, String param, String requestCode, String decryptKey,int isCheck ){
