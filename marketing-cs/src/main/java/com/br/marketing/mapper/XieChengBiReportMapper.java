...
public interface XieChengBiReportMapper {
    ...
    List<XiechengTransferWeeklyReportDTO> selectXcTransferSevenRollListbI_(@Param("reportDateStart") String reportDateStart, @Param("reportDateEnd") String reportDateEnd);
