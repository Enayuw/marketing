...
public interface MarketingSyncUserMapper {
    ...
    List<MarketingSyncUser> getYiXinNewSyncUserByDateAndResourceChannel(@Param("apiCode") String apiCode, @Param("appletDate") String appletDate,
        @Param("resourceChannel") String resourceChannel, @Param("userType") String userType, @Param("pageSize") Integer pageSize, @Param("minId") Long minId);
}
