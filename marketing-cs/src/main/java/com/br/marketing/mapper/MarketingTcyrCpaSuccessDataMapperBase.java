...
public interface MarketingTcyrCpaSuccessDataMapperBase {
    ...
    List<MarketingTcyrCpaSuccessData> selectByExampleWithBLOBs(MarketingTcyrCpaSuccessDataExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") MarketingTcyrCpaSuccessData record, @Param("example") MarketingTcyrCpaSuccessDataExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(MarketingTcyrCpaSuccessData record);
