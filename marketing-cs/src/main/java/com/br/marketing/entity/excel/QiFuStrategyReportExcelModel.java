...
public class QiFuStrategyReportExcelModel {
    ...
    @ExcelProperty(value = "画布", index = 1)
    private String canvasName;

    @ExcelProperty(value = "运营商", index = 2)
    ...
    @ExcelProperty(value = "完件用户数", index = 5)
    private String applySubmitUserCount;

    @ExcelProperty(value = "授信用户数", index = 6)
    private String creditSuccessUserCount;


    @ExcelProperty(value = "完件率", index = 7)
    private String applySubmitRate;

    @ExcelProperty(value = "通过率", index = 8)
    private String passRate;


    @ExcelProperty(value = "授信率", index = 9)
    private String creditSuccessRate;


    @ExcelProperty(value = "delta完件率", index = 10)
    private String deltaApplySubmitRate;


    @ExcelProperty(value = "delta授信率", index = 11)
    private String deltaCreditSuccessRate;


    @ExcelProperty(value = "delta完件量", index = 12)
    private String deltaApplySubmitCount;


    @ExcelProperty(value = "delta授信量", index = 13)
