    ...
    private void collidingData(DiDiCollidingDataRob data, String mediaName, String token, RateLimiter rateLimiter,
        ...
        try {
            ...
            if (mockEnable.equals(1)) {
                resData = "{\"httpcode\":200,\"content\":{\"errorCode\":10000,\"errorMessage\":\"成功\",\"data\":{\"couponType\":\"60free\",\"result\":true,\"msgType\":null,\"failReason\":null,\"userGroup\":3,\"nextTime\":1769327333000}}}";
