...
#JAVA_CMD="$CLOUDSERVER_JAVA_CMD $JAVA_OPTIONS  -cp $SERVICE_HOME/lib/*:$SERVICE_HOME/bean/$CONF_ENV $MAIN_CLASS "
...
if [[ $SERVICE_HOME == '/opt/SpringCloud/app/RULE-SERVICE' ]] ; then
    echo "规则服务" 
    #JAVA_CMD="$CLOUDSERVER_JAVA_CMD $JAVA_OPTIONS  -cp $SERVICE_HOME/lib/*:$SERVICE_HOME/bean/$CONF_ENV  $MAIN_CLASS $SERVICE_HOME/bean/$CONF_ENV/parseJs.js "
...
#PARAMS="--spring.bean.location=${SERVICE_HOME}/bean/${CONF_ENV}/ --server.tomcat.max-threads=1000"
