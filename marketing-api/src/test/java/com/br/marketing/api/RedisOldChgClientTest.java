...
import com.br.marketing.client.RedisOldChgClient;
...
public class RedisOldChgClientTest {
    @Autowired
    RedisOldChgClient redisChgService;
    ...
    @Test
    public void setnx() {
        Long juman3 = redisChgService.setnx("juman3", "123", 5000);
        Long juman3_error = redisChgService.setnx("juman3", "123", 5000);
        try {
            Thread.sleep(6000L);
    ...
    public void hkeys() {
        ...
        Set<String> juman7 = redisChgService.hkeys("juman7");
    ...
    @Test
    public void hset() {
        Long hset = redisChgService.hset("juman7", "key2", "v2");
        Long hset1 = redisChgService.hset("juman7", "key3", "v3");
